...
class RungeKutta4ExplicitMethod : public ExplicitMethod<Hydro> {
public:
...
template<typename Hydro>
void RungeKutta4ExplicitMethod<Hydro>::operator()(Hydro *hydro, Real dt, std::function<void(Hydro *hydro, Real dt, StateVector Cell::*dq_dt)> deriv) {
